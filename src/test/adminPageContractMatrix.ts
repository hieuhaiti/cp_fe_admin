...
export const adminPageContracts: readonly AdminPageContract[] = [
  ...
  { page: 'MapLayers', routes: ['/map-layers', '/map-layers/import-geojson'], mountStatus: 'mounted', sourceFiles: ['MapLayers/index.tsx', 'MapLayers/MapLayerDetailDialog.tsx', 'MapLayers/MapLayerFormDialog.tsx', 'MapLayers/GeoTiffUploadDialog.tsx', 'MapLayers/ShapefileImportDialog.tsx', 'MapLayers/ImportGeoJson.tsx'], testFiles: ['MapLayers/MapLayerFormDialog.test.tsx', 'MapLayers/GeoTiffUploadDialog.test.tsx', 'MapLayers/ShapefileImportDialog.test.tsx', 'MapLayers/ImportGeoJson.test.tsx', 'MapLayers/index.test.tsx'], formModes: ['create', 'edit', 'action'], routePermission: 'layers:read', operations: [
    ...
    op('shapefile-import', 'create', 'mapLayerService.importShapefile', 'POST', '/admin/layers/imports/shapefile', 'layer.routes.js', 'shapefileImportSchema', 'layers:create'),
