...
export default function News(): JSX.Element {
  ...
  const updateMutation = useApiMutation(
    (data: { id: number; payload: FormData | UpdateNewsBody }) => newsService.update(data.id, data.payload),
    {
      onSuccess: (_data, variables) => {
        const vars = variables as { id: number; payload: FormData | UpdateNewsBody }
  ...
  const deleteMutation = useApiMutation(
    (data: { id: number; expectedUpdatedAt: string }) => newsService.delete(data.id, data.expectedUpdatedAt),
    {
      onSuccess: () => {
        dbQuery.refetch()
  ...
  function handleDelete() {
    if (newsToDelete) {
      deleteMutation.mutate({
        id: newsToDelete.id,
        expectedUpdatedAt: newsToDelete.updatedAt ?? newsToDelete.updated_at ?? '',
      })
    }
  }
