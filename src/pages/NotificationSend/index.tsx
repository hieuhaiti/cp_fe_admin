...
const TYPE_GROUPS: {
  ...
  },
  {
    ...
    items: [
      ...
      { value: 'feedback_flood_report', label: 'Phản ánh ngập lụt (feedback_flood_report)' },
      {
...
const ROLE_OPTIONS = [
  ...
  { value: 'so_tnmt', label: 'Sở TN&MT Quảng Ninh' },
  { value: 'so_xd', label: 'Sở Xây dựng Quảng Ninh' },
  { value: 'ubnd_tp', label: 'UBND thành phố Cẩm Phả' },
