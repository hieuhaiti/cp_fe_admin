...
export default function DocumentPage(): JSX.Element {
  ...
  const deleteMutation = useApiMutation(
    (data: { id: number; expectedUpdatedAt: string }) => documentService.delete(data.id, data.expectedUpdatedAt),
    {
    onSuccess: () => {
      dbQuery.refetch()
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => itemToDelete && deleteMutation.mutate({
                id: Number(itemToDelete.id),
                expectedUpdatedAt: itemToDelete.updatedAt ?? itemToDelete.updated_at ?? '',
              })}
