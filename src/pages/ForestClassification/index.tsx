...
const getDistrictDownloadFilename = (district: ForestClassDistrictExport) =>
  ...
  `forest_class_${district.districtCode || 'campha'}.tif`
...
export default function ForestClassificationPage() {
  ...
  return (
    ...
    // height của <main> + cho phép cuộn nội dung.
          ...
          {isLoading ? (
            ...
            <>
              ...
              {/* Phân bố theo huyện — collapsible, mặc định đóng vì bảng dài
                  (các phường/xã Cẩm Phả × class columns) và không phải use case chính. */}
                  ...
                  {provinceDownloadUrl && (
                    <div className="flex items-center gap-2 rounded-md border border-emerald-200 bg-emerald-50/50 p-1.5">
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            await downloadRasterFile(provinceDownloadUrl, 'forest_class_campha.tif')
                          } catch {
