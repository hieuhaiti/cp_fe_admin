...
/**
 * Vai trò định nghĩa trong server sau migration Cẩm Phả:
 *   system_admin | ubnd_tp | so_tnmt | so_xd | citizen
 *
...
export const ROLE_LABELS: Record<string, string> = {
  ...
  [ROLES.UBND_TP]: 'UBND thành phố Cẩm Phả',
  [ROLES.SO_TNMT]: 'Sở TN&MT Quảng Ninh',
  [ROLES.SO_XD]: 'Sở Xây dựng Quảng Ninh',
...
export const ROLE_BADGE_CLASS: Record<string, string> = {
  ...
  [ROLES.UBND_TP]: 'bg-blue-100 text-blue-800 border-blue-200',
  [ROLES.SO_TNMT]: 'bg-emerald-100 text-emerald-800 border-emerald-200',
  [ROLES.SO_XD]: 'bg-amber-100 text-amber-800 border-amber-200',
